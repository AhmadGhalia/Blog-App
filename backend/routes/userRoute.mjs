...
import { verifyAdmin, verifytokenOnlyUser } from '../middlewares/varifyToken.mjs';
...
route.post('/profile/profile-photo-upload', photoUpload.single('image'), uploudUserPhoto);
